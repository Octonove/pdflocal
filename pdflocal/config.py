"""Configuracion y rutas de datos de PDFLocal (shim del nucleo compartido
...
LOG_PATH = get_data_dir() / "pdflocal.log"


@dataclass
class AppConfig:
    output_dir: str = field(default_factory=lambda: str(default_output_dir()))
    last_dir: str = ""                 # ultima carpeta usada al abrir
    ollama_model: str = ""             # LLM para chat ("" = auto)
    ollama_embed_model: str = ""       # modelo de embeddings ("" = auto)
